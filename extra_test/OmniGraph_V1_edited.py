...
# 1a Node neighbors and weights are represented relative to the node name in a single data structure.
# 2. Nodes have identifiers.
# 3. Graph can accommodate both undirected and directed edges.
# 4. edge(s) refers to undirected edge(s).
# 5. arc(s) refers directed edge(s).
# 5a.edge(s) are represented with two arcs
# 6. Individual nodes have to be added before edges are added.
